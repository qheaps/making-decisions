...
if (temperature > 80 && rain) {
  ...
  console.log(`You should wear a t-shirt and not take an umbrella.`)
} else if(temperature < 80 && temperature > 60 && rain) {
  console.log(`You should wear a rainjacket and take an umbrella.`)
  ...
  console.log(`You should wear a sweater and not take an umbrella.`)
}
